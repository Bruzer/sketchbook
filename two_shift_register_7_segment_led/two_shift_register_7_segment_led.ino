...
*/
/**
 * This program drives two 7-segment LED from two 74HC595 shift registers.
 * 
 * Wiring setup:
...
void loop() {
  ...
  for (int a = 0; a < 100; a++) {
    ...
    if (debug) {
      Serial.print(" = 0x");
      Serial.print(digitArray[tens], HEX);
      Serial.print(" 0x");
      Serial.println(digitArray[ones], HEX);
    }
    ...
    shiftOut(dataPin, clockPin, LSBFIRST, digitArray[tens]);
